...
twitch_miner = TwitchChannelPointsMiner(
    username="WiosennyDeszcz66",
    password=">G22Y#5j5ayg",           # If no password will be provided, the script will ask interactively
